...
Democracy 2.1 has yet to be adopted, however a field test that polled over 2,500 voters after they voted in the Czech 2013 parliamentary elections found that the mechanism was easily understood, and the most extreme parties tended to lose out. In general we expect these extremist parties to not be socially optimal. 
